...
public class ClspGraph {
	...
	public ClspClass getClsDetails(ArgType type) {
		...
		return Nullability.castToNonnull(nameMap).get(type.getObject());
	}
	...
	public Set<String> getSuperTypes(String clsName) {
		Map<String, Set<String>> map = Nullability.castToNonnull(superTypesCache);
		Set<String> result = map.get(clsName);
	...
	private void fillSuperTypesCache() {
		...
		Map<String, Set<String>> map = new HashMap<>(Nullability.castToNonnull(nameMap).size());
